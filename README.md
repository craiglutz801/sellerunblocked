...
- **Product app** (`/app/*`) — Revenue Organization Intelligence UI for licensed customers. Spec: `SellerUnblocked_Product_Blueprint.md`. Uses sample data until backend and auth are wired.
